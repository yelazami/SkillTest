 ...
 */
class getSecurity_EventDispatcher_ApiTokenRefreshService extends App_Shared_Infrastructure_KernelDevDebugContainer
{
    /**
     * Gets the private 'security.event_dispatcher.api_token_refresh' shared service.
     *
     * @return \Symfony\Component\EventDispatcher\EventDispatcher
     */
    public static function do($container, $lazyLoad = true)
    {
        $container->privates['security.event_dispatcher.api_token_refresh'] = $instance = new \Symfony\Component\EventDispatcher\EventDispatcher();

        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\CheckPassportEvent', [0 => function () use ($container) {
            return ($container->privates['security.listener.user_checker.api_token_refresh'] ?? $container->load('getSecurity_Listener_UserChecker_ApiTokenRefreshService'));
